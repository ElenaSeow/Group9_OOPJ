 ...
 * @author User
 */
public class AdminEMTCreate extends javax.swing.JFrame {
     Session Session;
     String id;
     ...
     */
    public AdminEMTCreate(Session session) {
        initComponents();
        this.Session = session;
        id= session.getId();
        technicians = new Technician().Import();
        TechRole.setText("Technician");
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        technicians.add(new Technician(ID,Name,Role,Num));
        Technician.Write(technicians);
