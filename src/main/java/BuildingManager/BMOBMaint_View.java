 ...
 * @author User
 */
public class BMOBMaint_View extends javax.swing.JFrame {
    Session Session;
    String id;
     ...
     */
    public BMOBMaint_View(Session session) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BMOBMaint_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
