 ...
 * @author User
 */
public class BMRComplaint extends javax.swing.JFrame {
    Session Session;
    ArrayList<Complaint> complaints = new Complaint().Import();
    /**
     * Creates new form BMRInvoice
     */
    public BMRComplaint(Session session) {
        initComponents();
        this.Session =session;
        Complaint.tabulateReport(ComplaintTable);
        Counter.setText(Functions.getCount(ComplaintTable));
    }
    ...
    private void initComponents() {
        ...
        ComplaintTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Complaint", "Status", "Complaint Date", "Last Updated"
            }
        ));
        ...
        jLabel2.setText("Total Complaints : ");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(choice.equals("This Month")){
            ...
            Complaint.tabulateReport1(ComplaintTable);
            Counter.setText(Functions.getCount(ComplaintTable));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BMRComplaint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
