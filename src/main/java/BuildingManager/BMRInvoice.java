 ...
 * @author User
 */
public class BMRInvoice extends javax.swing.JFrame {
    Session Session;
    ArrayList<Invoices> invoices = new Invoices().Import();
    /**
     * Creates new form BMRInvoice
     */
    public BMRInvoice(Session session) {
        initComponents();
        this.Session =session;
        Invoices.tabulateReport(InvoiceReport);
        Counter.setText(Functions.getCount(InvoiceReport));
    }
    ...
    private void initComponents() {
        ...
        InvoiceReport.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice ID", "Unit No", "Name", "Fee", "Date"
            }
        ));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(choice.equals("This Month")){
            ...
            Invoices.tabulateReport1(InvoiceReport);
            Counter.setText(Functions.getCount(InvoiceReport));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BMRInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
