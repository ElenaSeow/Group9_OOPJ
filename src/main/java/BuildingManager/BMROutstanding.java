 ...
 * @author User
 */
public class BMROutstanding extends javax.swing.JFrame {
    Session Session;
    ArrayList<Invoices> invoices = new Invoices().Import();
    /**
     * Creates new form BMRInvoice
     */
    public BMROutstanding(Session session) {
        initComponents();
        this.Session =session;
        Invoices.tabulateReportOut(OutstandingReport);
        Counter.setText(Functions.getCount(OutstandingReport));
    }
    ...
    private void initComponents() {
        ...
        OutstandingReport = new javax.swing.JTable();
        ...
        OutstandingReport.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "Unit No", "Name", "Outstanding", "Date"
            }
        ));
        jScrollPane1.setViewportView(OutstandingReport);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(choice.equals("This Month")){
            ...
            Invoices.tabulateReportOut1(OutstandingReport);
            Counter.setText(Functions.getCount(OutstandingReport));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BMROutstanding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        });
    ...
    private javax.swing.JTable OutstandingReport;
