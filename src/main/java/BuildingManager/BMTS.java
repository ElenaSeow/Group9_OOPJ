 ...
 * @author HP
 */
public class BMTS extends javax.swing.JFrame {
    Session Session;
    ArrayList<TeamStructure> teamstructures = TeamStructure.Import();
    /**
     * Creates new form Building_Manager_Sample
     */
    public BMTS(Session session) {
        initComponents();
         TeamStructure.tabulateData(teamstructures, TStable);
    ...
    private void initComponents() {
        ...
        TStable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Team ID", "Operation ID", "Role", "Amount", "Remarks"
            }
        ));
        jScrollPane1.setViewportView(TStable);
...
//        dispose();
    ...
    private void CreateButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CreateButtonMouseClicked
        // TODO add your handling code here:
//        BMTSCreate bmtsc = new BMTSCreate(Session);
//        bmtsc.setVisible(true);
//        dispose();
    }//GEN-LAST:event_CreateButtonMouseClicked

    private void UpdateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButtonActionPerformed
        // TODO add your handling code here:
        if(TStable.getSelectionModel().isSelectionEmpty()==false){
            int column = 0;
            int row = TStable.getSelectedRow();
            String Id = TStable.getModel().getValueAt(TStable.convertRowIndexToModel(row), column).toString();
            BMTSUpdate tu = new BMTSUpdate(Session);
            tu.spamdata(Id);
            tu.setVisible(true);
            dispose();
        }else{
