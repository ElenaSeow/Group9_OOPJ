 ...
 * @author User
 */
public class BMUMCreate_AE extends javax.swing.JFrame {
    Session Session;
    ArrayList<AccountExecutive> ae = new AccountExecutive().Import();
    /**
     * Creates new form User_Form
     */

    public BMUMCreate_AE(Session session) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        AccountExecutive newae = new AccountExecutive(id,name,email,password,role,number);
        ae.add(newae);
        AccountExecutive.Write(ae);
