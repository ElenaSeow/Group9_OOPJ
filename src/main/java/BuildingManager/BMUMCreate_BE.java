 ...
 * @author User
 */
public class BMUMCreate_BE extends javax.swing.JFrame {
    Session Session;
    ...
    public BMUMCreate_BE(Session session) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        BuildingExecutive newbe = new BuildingExecutive(id,name,email,password,role,number);
        buildingexecutives.add(newbe);
        BuildingExecutive.Write(buildingexecutives);
