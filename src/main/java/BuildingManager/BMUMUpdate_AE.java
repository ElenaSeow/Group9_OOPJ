 ...
 * @author User
 */
public class BMUMUpdate_AE extends javax.swing.JFrame {
    Session Session;
    ...
    public BMUMUpdate_AE(Session session) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        ae=new AccountExecutive(id,name,email,password,role,number).Update(ae, id);
