 ...
 * @author User
 */
public class BMUMUpdate_BE extends javax.swing.JFrame {
    Session Session;
    ...
    public BMUMUpdate_BE(Session session) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        buildingexecutives=new BuildingExecutive(id,name,email,password,role,number).Update(buildingexecutives, id);
