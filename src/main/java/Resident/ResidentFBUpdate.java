 ...
 * @author User
 */
public class ResidentFBUpdate extends javax.swing.JFrame {
    Session Session;
     ...
     */
    public ResidentFBUpdate(Session session) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        try {
            ...
            Logger.getLogger(ResidentFBUpdate.class.getName()).log(Level.SEVERE, null, ex);
        }
