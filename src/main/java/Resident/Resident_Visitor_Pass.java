 ...
 * @author HP
 */
public class Resident_Visitor_Pass extends javax.swing.JFrame {

    /**
     * Creates new form Resident_Visitor_Pass
     */
    public Resident_Visitor_Pass() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resident_Visitor_Pass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Resident_Visitor_Pass().setVisible(true);
            }
        });
    }
