 ...
 * @author Ryan
 */
public class Main_Page_Facilities extends javax.swing.JFrame {

    /**
     * Creates new form Main_Page_Facilities
     */
    public Main_Page_Facilities() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Main_Page_Facilities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Main_Page_Facilities().setVisible(true);
            }
        });
    }
